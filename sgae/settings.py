...
SECRET_KEY = 'django-insecure-x)x24o!7a5+!j97d%vaj5=(^v1_hk-!h-%p%4#yi9#(1th6%bg'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.context_processors',
                'core.context_processors.dados_graficos',
            ],
        },
    },
]
