...
def salas(request, pk=None):
    ...
    if sala and request.method == 'POST':
        try:
            ...
            messages.error(request, f"Erro ao atualizar sala, consulte o administrador")
            return redirect('cadastros:salas')
    ...
    if not sala and request.method == 'POST':
        try:
            ...
            messages.error(request, 'Erro ao cadastrar sala, consulte o administrador')
...
def disciplinas(request, pk=None):
    ...
    if disciplina is not None and request.method == 'POST':
        try:
            ...
            messages.error(request, 'Erro ao atualizar disciplina, consulte o administrador')
        ...
        try:
            ...
            messages.error(request, 'Erro ao cadastrar disciplina, consulte o administrador')
...
def excluir_disciplina(request, pk):
    ...
    if disciplina:
        try:
            ...
            messages.error(request, 'Erros ao excluir disciplina, consulte o administrador')
...
def professores(request, pk=None):
    ...
    if request.method == 'POST':
        try:
            ...
            messages.error(request, 'Erro ao atualizar professor, consulte o administrador')
            ...
            try:
                ...
                messages.error(request, 'Erro ao cadastrar professor, consulte o administrador')
...
def excluir_professor(request, pk):
    ...
    if professor:
        try:
            ...
            messages.error(request, 'Erro ao excluir professor(a), consulte o administrador')
    ...
    if request.method == 'POST':
        try:
            ...
            if aluno is not None:
                ...
                messages.success(request, 'Alunos atualizado com sucesso')
            ...
            messages.error(request, 'Erro ao atualizar aluno, consulte o administrador')
            ...
            try:
                ...
                messages.error(request, 'Erro ao cadastrar aluno, consulte o administrador')
